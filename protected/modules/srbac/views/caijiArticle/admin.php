...
$('.search-form form').submit(function(){
	$('#caiji-article-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<script type="text/javascript">
    ...
    var deleteAll = function (){
        ...
        if(data.length > 0){
            $.post('http://www.cha.com/srbac/caiji-article/delall',{'selectdel[]':data}, function (data) {
            	var json = eval('(' + data + ')'); 
        	    if(json.statu == 0){
