...
class LianxijiluController extends Controller
{
	/**
	...
	{
		$dataProvider=new CActiveDataProvider('ContactRecord');
	 ...
	 * @return ContactRecord the loaded model
	 ...
	 * @param ContactRecord $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='contact-record-form')
		{
