...
class Config extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('site_logo', 'required'),
			array('site_id', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id,site_code,seo_title,site_slogan, site_name, site_url, seo_description, seo_keywords, site_logo,qq_key,sina_key,qq_secret,sina_secret,host,port,username,password,from,site_id', 'safe'),
		);
	}
