...
class CaijiArticle extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('create_time, status, caiji_id, click, cate_id', 'numerical', 'integerOnly'=>true),
			array('title, keywords, des, laiyuan', 'length', 'max'=>255),
			array('content, mark', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, title, content, keywords, des, create_time, status, mark, caiji_id, click, cate_id, laiyuan', 'safe', 'on'=>'search'),
		);
	}
