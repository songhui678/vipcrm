...
class Topic extends CActiveRecord
{
	...
	public function getContentCiku(){
		$ciku = Ciku::model()->findAll();
		$content = $this->content;
		foreach ($ciku as $key => $value) {
			$replace = "<a href='$value->url'><strong>$value->keyword</strong></a>";
			$content = str_replace($value->keyword, $replace, $content);
		}
		return $content;
	}
