...
return array(
	...
	'components' => array(
		...
		'authManager' => array(
			...
			'connectionID' => 'db',
			'itemTable' => 'cm_items',
			'assignmentTable' => 'cm_assignments',
			'itemChildTable' => 'cm_itemchildren',
		),
		...
		'urlManager' => array(
			...
			'rules' => array(
				...
				// 个人空间
				'/kongjian/<uid:\d+>' => array('/kongjian/index', 'urlSuffix' => '/'),
				// 文章重写
				'/ac/<cateId:\d+>' => 'article/index',
				'/ac' => 'article/index',
				'/ac' => 'article',
				'/a<id:\d+>' => array('article/show', 'urlSuffix' => '.html'),

				'/topic/<uid:\d+>/<id:\d+>' => array('group/topic', 'urlSuffix' => '/'),
				'/topic/<id:\d+>' => array('group/topic', 'urlSuffix' => '/'),
				'/group/<page:\d+>/<id:\d+>' => array('group/detail', 'urlSuffix' => '/'),
				'/group/<id:\d+>' => array('group/detail', 'urlSuffix' => '/'),

				'topics/<page:\d+>' => 'group/exploretopic',
				'topics' => 'group/exploretopic',

				'groups' => 'group/explore',
