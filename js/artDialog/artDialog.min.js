 ...
 */ (function(e, t) {
	...
	return e.$ === t && (e.$ = n), n.fn = n.prototype = {
		constructor: function(e, t) {
			...
			if (typeof e == "string") {
				n = r.exec(e);
				if (n && n[2]) return i = t.getElementById(n[2]), i && i.parentNode && (this[0] = i), this
			}
		...
		var t, r = this[0],
			i = e.split(".")[1];
		return i ? document.getElementsByClassName ? t = r.getElementsByClassName(i) : t = s(i, r) : t = r.getElementsByTagName(e), n(t[0])
	}, n.each = function(e, n) {
		var r, i = 0,
			s = e.length,
			o = s === t;
		...
		if (t) {
			...
			for (var f in a) r = !1;
			r && delete n.cache[u]
		} else delete s[u], e.removeAttribute ? e.removeAttribute(i) : e[i] = null
		...
		remove: function(e, t, r) {
			...
			else s.listeners = []; if (s.listeners.length === 0) {
		...
		n.fn[r] = function() {
			var t = this[0],
				n;
			return n = u(t), n ? "pageXOffset" in n ? n[e ? "pageYOffset" : "pageXOffset"] : n.document.documentElement[r] || n.document.body[r] : t[r]
		}
...
function(e, t, n) {
	...
	var r, i = 0,
		...
		o = e(document.getElementsByTagName("html")[0]),
		u = "artDialog" + +(new Date),
		a = t.VBArray && !t.XMLHttpRequest,
		...
		c = function(e, t, o) {
			...
			var a, h = c.defaults,
				p = e.follow = this.nodeType === 1 && this || e.follow;
	...
	c.version = "5.0.3", c.fn = c.prototype = {
		...
		button: function() {
			var t = this.dom,
				...
				r = n[0],
				i = "d-state-highlight",
				s = this._listeners = this._listeners || {}, o = [].slice.call(arguments),
				a = 0,
				f, l, c, h, p;
